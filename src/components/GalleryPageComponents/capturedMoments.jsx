...
export default function CapturedMomentSection(){
    return(
        <section id="capture" className="h-screen  bg-transparent">
                <div className="bg-transparent h-screen grid grid-cols-2 gap-1">
                        <div className="bg-transparent p-4">
                            ...
                            className=" h-full  flex flex-col p-4">
                                ...
                                <div
                                className="bg-white h-1/4 rounded-b-4xl p-5">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-bold font-serif">Angelo Garcia</span>
                                    
                                    </div>
                                    <div className="flex pl-12">
                                        <span className=" font-sans text-md font-light">
                        ...
                        <div className="bg-transparent flex flex-col gap-4 p-4">
                            ...
                            <div
                            className="bg-transparent h-1/2 rounded-2xl bg-cover bg-center flex gap-2 p-4">
