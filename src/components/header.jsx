        ...
        <div className="scroll-smooth">
                ...
                <div className={`md:flex justify-between  px-2 py-2 md:px-6 md:py-4 text-white bg-transparent top-0 left-0 w-full z-50 hidden ${menuState ? 'hidden' : 'md:fixed' }`}>
                    ...
                    <nav  className=' flex gap-5  scale-75 md:scale-100' >                        
                            <a href="#hero" className=' hover:text-amber-200 hover:text-lg' >Home</a> 
                            <a href="#menu" className=' hover:text-amber-200 hover:text-lg' >Menu</a>                        
                            <a href="#gallery" className=' hover:text-amber-200 hover:text-lg' >Gallery</a>
                            <a href="#about" className=' hover:text-amber-200 hover:text-lg' >About</a>
                            <a href="#contact" className=' hover:text-amber-200 hover:text-lg' >Contact</a>
